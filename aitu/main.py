...
['/y Иә✅', '/n кері_көшу❌'],
['''Сәлеметсіз бе🤗, мен QolKanat ботымын, мен сізге 24/7⏰ қызмет көрсетуге дайынмын! /start командасын жіберуді ұмытпаңыз😁❕Маған медициналық нәтижелеріңізді PDF форматында жіберіңіз...'''],
['''Сіз графикті📊 алу батырмасын бастыңыз. Нені алғыңыз келетінін таңдаңыз🤔 :'''],
['Басты меню'],
['файл:', 'жүктелген'],
['Деректер жоқ! Маған PDF файлдарды жіберіңіз!'],
